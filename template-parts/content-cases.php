    ...
    <div class="container py-4">
        <div class="row">
            <div class="col-12 d-flex flex-column align-items-center text-center">
                <h2 class="d-text-green-dark d-font-bold d-text-xxxxl mb-3"><?php echo get_the_title( 95 ); ?></h2>
                <p class="d-text-color-dark d-font-medium d-text-md mb-4 w-50"><?php echo get_post_field( 'post_content', 95 ); ?></p>
            </div>
        </div>
                        ...
                        <div class="c-banner-cases">
                            ...
                            <div>
                                <p class="c-banner-cases__text">
                                    ...
                                    <?php the_field('cases_cliente_descricao'); ?>
                                    <span class="c-banner-cases__quotes --right material-icons w-100 text-end d-brand-color">format_quote</span>
                                </p>
