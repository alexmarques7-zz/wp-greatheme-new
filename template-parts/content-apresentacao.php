        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-5 pe-lg-4 mt-2 pb-3 mb-5">
                ...
                <?php if (is_page_template( 'page-educacional.php' )): ?>
                    <h2 class="d-text-green-dark d-font-bold d-text-xxxl mb-3"><?php the_field('apresentacao-titulo-educacional',54); ?></h2>
                    <p class="d-text-green-dark d-font-medium d-text-sm mb-4"><?php the_field('apresentacao-texto-educacional',54); ?></p>
                    <a class="e-btn" title="<?php the_field('texto_do_botao', 54); ?>" href="#"><?php the_field('texto_do_botao',54); ?></a>
                <?php else: ?>
                    <h2 class="d-text-green-dark d-font-bold d-text-xxxl mb-3"><?php the_field('apresentacao-titulo-corporativo',54); ?></h2>
                    <p class="d-text-green-dark d-font-medium d-text-sm mb-4"><?php the_field('apresentacao-texto-corporativo',54); ?></p>
