<div class="p-producao-de-conteudo">
    ...
    <div class="container-fluid d-select-none py-5 d-bg-gray-light">
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-lg-4 d-flex flex-column align-items-center text-center mb-5 mb-lg-0">
                ...
                <div class="col-12 col-sm-6 col-lg-4 d-flex flex-column align-items-center text-center0">
